...
data= read.table(file.path(paste(foldername, "/ClusterCentroids_Ch2_v1.txt", sep="")))
...
writeRes(res, file.path(paste(foldername, "/r_vs_thresh_ClusterCentroids_Ch2_v1.txt", sep="")), file.path(paste(foldername, "/labels", sep="")), bestonly=bestonly)
