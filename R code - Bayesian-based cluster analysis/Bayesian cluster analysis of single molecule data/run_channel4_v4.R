...
data= read.csv(file.path(paste(foldername, "/data_channel4.txt", sep="")))
...
writeRes(res, file.path(paste(foldername, "/r_vs_thresh_channel4.txt", sep="")), file.path(paste(foldername, "/labels", sep="")), bestonly=bestonly)
